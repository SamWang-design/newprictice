...
public class sendMassage {
    public static sendMassage send(String phone, String key){
        //第二个参数为自己独有的accessKeyid，第三个参数为自己独有的accessKeySecret
        DefaultProfile profile = DefaultProfile.getProfile("cn-beijing",
                "LTAI4Fqv8xnVbsgVbHcUEe5B","mzWZQSRYrNmbaONYxCoEKOhjeg3S1s");
        ...
        request.putQueryParameter("TemplateCode", "SMS_180956839");
